	...
	proc
		...
		*/
		...
		block_collision(atom/a)
			...
			//world.log << "[a.name]"
			//world.log << "ix:[ix] = px:[px]||px(2)[src.px] + move_x:[move_x] + pwidth:[pwidth] - building.px:[a.px]"
		...
		//	world.log << "[a.name]"
			//world.log << "iy:[iy] = py:[py] + move_y:[move_y] + pheight:[pheight] - building.py:[a.py]"
