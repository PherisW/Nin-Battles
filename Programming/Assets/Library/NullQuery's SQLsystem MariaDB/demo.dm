// Use the following to get started. This assumes you have your own local MySQL server running
// with the user "root" (no password) with the database "testdb".

/proc/main()
	try
		// Open a new connection.
		var/sql4dm/MysqlDatabaseConnection/conn = new("http://192.168.10.186", 3307, "Pokemondb", "Super-Russell-Discord", "Pokemondb")
